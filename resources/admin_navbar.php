...
.nav-item{
	...
	<div class="container-fluid">
		<a class="navbar-brand" href="<?= AREF_DIR_ADMIN ?>">Σύστημα Διαχείρισης Στατιστικών Πρωταθλημάτων Μπάσκετ</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				...
				<li class="nav-item">
					<a class="nav-link <?= ($currPage === 'searchPlayers') ? ' active' : '' ?>" href="<?= AREF_ADMIN_SEARCH_PLAYERS ?>">Αναζήτηση Παικτών</a>
				</li>
				<li class="nav-item">
					<a class="nav-link <?= ($currPage === 'searchTeam') ? ' active' : '' ?>" href="<?= AREF_ADMIN_SEARCH_TEAM ?>">Αναζήτηση Ομάδων</a>
				</li>
			</ul>
